...
namespace App1
{
    ...
    public sealed partial class BasicPage1 : Page
    {
        ...
        {
            LibraryMedia.Current.FillSync();
            this.DataContext = LibraryMedia.Current;
        ...
        {
            if (LibraryMedia.Current.ListTitle.Count == 0)
                LibraryMedia.Current.FillSync();
            this.Affichage.ItemsSource = LibraryMedia.Current.ListTitle;
        }

        private void LoadVideo(object sender, RoutedEventArgs e)
        {
            if (LibraryMedia.Current.ListVideo.Count == 0)
                LibraryMedia.Current.FillVideo();
            this.Affichage.ItemsSource = LibraryMedia.Current.ListVideo;
        }

        private void SelectItem(object sender, ItemClickEventArgs e)
        {
            var album = e.ClickedItem as Music;

            this.Frame.Navigate(typeof(MainPage), album.Path);
        }
    }
}
